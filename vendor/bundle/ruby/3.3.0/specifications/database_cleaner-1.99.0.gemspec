...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<activerecord-mysql2-adapter>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<activerecord>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<datamapper>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<dm-migrations>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<dm-sqlite-adapter>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<mongoid>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<tzinfo>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<mongoid-tree>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<mongo_mapper>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<mongo>.freeze, ["~> 1.12.0".freeze])
  s.add_development_dependency(%q<moped>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<neo4j-core>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<couch_potato>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<sequel>.freeze, ["~> 3.21.0".freeze])
  s.add_development_dependency(%q<ohm>.freeze, ["~> 0.1.3".freeze])
  ...
  s.add_development_dependency(%q<mongo_ext>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<bson_ext>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<mysql>.freeze, ["~> 2.9.1".freeze])
